  ...
  return knex('nurses').del()
    .then(function () {
      ...
      return knex('nurses').insert([
        ...
        {first_name: 'Nurse', last_name: 'Master', active: true, image: 'http://localhost:8080/images/nurses/8.jpg', password: passwordHash, is_nurse: true},
        {first_name: 'Joe', last_name: 'Delconte', active: true, image: 'http://localhost:8080/images/nurses/2.jpg', password: passwordHash, is_nurse: true},
        {first_name: 'Trey', last_name: 'Foresberg', active: true, image: 'http://localhost:8080/images/nurses/3.jpg', password: passwordHash, is_nurse: true},
