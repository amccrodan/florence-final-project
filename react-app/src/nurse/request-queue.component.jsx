        ...
        {this.props.requests.map(request => {
          ...
          function reqCategory(request_type_id){
            switch (request_type_id){
              ...
              case 2:
                return <div><i className='fa fa-male' aria-hidden='true'></i> <i className='fa fa-female' aria-hidden='true'></i></div>
                break;

              case 3:
                return <i className='fa fa-medkit' aria-hidden='true'></i>
                break;
